...
export const GET_ACTIVE_USER = "getAllActiveUsers";
export const GET_USER = "getUser";
export const STATUS_USER = "changeUserStatus";
export const UPDATE_USER = "updateUser";

export const CREATE_COMPANY = "addCompany";
export const GET_ACTIVE_COMPANY = "getAllActiveCompany";
export const GET_COMPANY = "getAllCompany";
export const STATUS_COMPANY = "changeCompanyStatus";
export const UPDATE_COMPANY = "updateCompany";

export const CREATE_ROLE = "addRole";
export const GET_ACTIVE_ROLE = "getAllActiveRole";
export const GET_ROLE = "getRoles";
export const STATUS_ROLE = "changeRoleStatus";
export const UPDATE_ROLE = "updateRole";

export const CREATE_SERVERIP = "addServerIP";
export const GET_ACTIVE_SERVERIP = "getAllActiveServerIP";
export const GET_SERVERIP = "getServerIP";
export const STATUS_SERVERIP = "changeServerIPStatus";
export const UPDATE_SERVERIP = "updateServerIP";

export const CREATE_NUMBER = "addNumber";
export const GET_ACTIVE_NUMBER = "getAllActiveNumbers";
export const GET_NUMBER = "getNumbers";
export const STATUS_NUMBER = "changeNumberStatus";
export const UPDATE_NUMBER = "updateNumber";

export const CREATE_Target = "getTarget";
export const GET_ACTIVE_Target = "getAllActiveTarget";
export const GET_TARGET = "getTarget";
export const STATUS_Target = "changeTargetStatus";
export const UPDATE_Target = "updateTarget";

export const CREATE_CARRIER = "addCarrier";
export const GET_ACTIVE_CARRIER = "getAllActiveCarriers";
...
export const STATUS_CAMPAIGN = "changeCampaignStatus";
export const UPDATE_CAMPAIGN = "updateCampaign";

export const CREATE_ROLE_PERMISSION = "createRolePermissions";
export const UPDATE_ROLE_PERMISSION = "updateRolePermissions";
